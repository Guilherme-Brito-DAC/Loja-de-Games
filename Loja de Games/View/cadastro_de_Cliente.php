...
<body>
    <main>
        <form method="POST" action="../index.php?acao=cadastroCliente">
            ...
            <br/>
            <span><p style="opacity:0.6">Já possui uma conta?</p><a href="./login_de_cliente.php">Login</a></span>
        </form>
    </main>
    <a href="./cadastro_de_funcionario.php" id="funcionario">Sou funcionario</a>
</body>
