...
<head>
    ...
    <div class="menu">
        ...
        <form action="../index.php?acao=editarUmJogo" class="jogosForm" method="post">
            <div>
                <input type="hidden" name="id"  value="<?= $_SESSION["Jogo"]["id"] ?>"/>
                <h1 class="titulo">Edição de jogo</h1>
                <input type="text" name="nome" placeholder="Nome" value="<?= $_SESSION["Jogo"]["nome"] ?>" required/>
                <br/>
                ...
                <input type="number" placeholder="Classificação" min="10" max="18" value="<?= $_SESSION["Jogo"]["classificacao"] ?>"  name="classificacao" required/>
                <br/>
                <input type="number" placeholder="Estoque" min="0" value="<?= $_SESSION["Jogo"]["estoque"] ?>" name="estoque" required/>
                <br/>
                <button type="submit">Editar</button>
            </div>
            <div>
                <input type="text" id="imagem" value="<?= $_SESSION["Jogo"]["imagem"] ?>" placeholder="Cole a url da imagem aqui...." name="imagem" required/>
                <br />
                <label>Preview</label>
                <br />
                <img src="<?= $_SESSION["Jogo"]["imagem"] ?>" id="preview"/>
            </div>
        </form>
