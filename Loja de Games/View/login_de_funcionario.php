...
<body>
    ...
    <main>
        <form method="POST" action="../index.php?acao=loginFuncionario">
            ...
            <br/>
            <span><p style="opacity:0.6">Não tem uma conta ainda?</p><a href="./cadastro_de_funcionario.php">Cadastro</a></span>
        </form>
    </main>
    <a href="./login_de_cliente.php" id="funcionario">Sou Cliente</a>
</body>
